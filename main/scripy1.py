...
class MyCarTask:
    ...
    def front(self):
        ...
        self.my_car.task.arm.set_hand_angle(60)
        ...
        self.my_car.lane_dis_offset(0.3, 5.2)          #####(0.3, 4.4)
    ...
    def end(self):
        ...
        time.sleep(1)
        self.my_car.lane_det_location_v4(0.2, tar, side=-1, dis_out=5)  # 巡航找文字
        ...
        self.my_car.lane_det_location_vert(0.15, tar, side=-1, dis_out=5)
        ...
        if y < 0 or y == 0:
            ...
            self.my_car.task.arm.set_hand_angle(-80)  # 掌心向前
        ...
        time.sleep(1)
        self.my_car.lane_det_location_v4(0.2, tar, side=1, dis_out=5)  # 巡航找文本
        try:
            text = self.my_car.get_ocr_list_plus()[0]  # 获取文字
            foods = answer.ask1(text)
        ...
        self.my_car.lane_det_location_vert(0.135, tar, side=1, dis_out=5)
        img_side = self.my_car.cap_side.read()
        dets_ret = self.my_car.task_det(img_side)
        ...
        time.sleep(0.5)
        self.my_car.task.arm.set_hand_angle(-80)
        time.sleep(0.5)
        ...
        self.my_car.lane_det_location_v4(0.2, tar, side=-1, dis_out=5)  # 巡航到第一列有文字的地方
        time.sleep(0.5)
        try:
        ...
        self.my_car.lane_det_location_v4(0.2, tar, side=-1, dis_out=5)  # 巡航到第二列有文字的地方
        time.sleep(1)
        ...
        self.my_car.task.arm.switch_side(1)
        self.my_car.set_pose_offset([0.25, 0, 0])
        #my_car.task.arm.switch_side(1)
        self.my_car.task.arm.set(0.25, 0.07) 
        self.my_car.set_pose_offset([0, 0.15, 0])
        self.my_car.set_pose_offset([-0.1,0,0])
        self.my_car.set_pose_offset([0, -0.15, 0])
        self.my_car.set_pose_offset([-0.2, 0, 0])
        self.my_car.set_pose_offset([0, 0.3, 0])
        
        self.my_car.set_pose_offset([0, -0.3, 0])
        
        self.my_car.set_pose_offset([0.8, 0, 0])
