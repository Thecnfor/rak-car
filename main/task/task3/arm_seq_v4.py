#!/usr/bin/python3
# -*- coding: utf-8 -*-
r"""main/tasks/task333/arm_seq_v4.py - sequenced arm motion v4
...
Usage:
    ...
    python -m main.tasks.task333.arm_seq_v4
"""
...
def main():
    ap = argparse.ArgumentParser(description="arm sequence v4")
    ...
    print("[seq] starting arm sequence v4", flush=True)
    b = read_arm(client)
    ...
    print(f"\n[3/5] move_x_position({args.x}) + set_arm_angle({args.arm_angle}, "
