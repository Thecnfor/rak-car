...
业务映射（重要，别记错）:
  ...
  - 车体右侧 = 大臂正方向 (+93°，本模块取值)；+93° 在业务硬限 [+150, -150]° 边界内。
  - LEFT/MID/RIGHT 业务枚举硬限 [+150, -150]°，**禁止** SIDES 直传 (历史已删)。
...
# 业务硬限 [+150, -150]°（2026-07-27 重定义，2026-08-05 +90→+150 用户放宽）：
# +150 是新对称上界，+90 是复位位，-150 是结构极限。
