...
TASK4_GRASP_X_OFFSET_MM: float = 0.0
"""盲降抓球时 x 后缩量 (mm, 正=往正方向缩回, 远离下限)。
⚠️ setpoint 回退到 (-0.03,-0.74) 后归零; 如现场仍需补偿在此调整。"""
...
#    ⚠️ 2026-08-10 测试: setpoint=(0,0) 导致 settle 失败 (误差=检测框中心,
#    球在画面中心时 dx=dy=0 但实际抓取位不在吸嘴下方, settle 卡不住)。回退到此值。
