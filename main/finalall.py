...
def hanoi():
    ...
    if side == -1:
        ...
        #my_car.set_pose_offset([0, 0, -math.pi / 28 * side])
        #time.sleep(0.3)
...
def camp():
    ...
    my_car.set_vel_time(0.3, 0, -0.53, 6)
    my_car.set_vel_time(0.3, -0.06, -0.52, 2)
    
    print("11111111111")
    my_car.lane_dis_offset(0.3, 3.0)
    #my_car.lane_dis_offset(0.3, 4.58)
    my_car.set_pose_offset([0, 0, -math.pi /14], 1)
...
def get_food():
    ...
    my_car.lane_det_location_vert(0.15, tar, side=-1, dis_out=4)
    ...
    time.sleep(1)
    my_car.lane_det_location_v4(0.2, tar, side=1, dis_out=4)  # 巡航找文本
    try:
        text = my_car.get_ocr_list_plus()[0]  # 获取文字
        foods = answer_wenxin.ask1(text)
    ...
    my_car.set_pose_offset([0, -0.05, 0], 0.2)     
...
def eject2():
    ...
    my_car.lane_sensor(0.27, value_h=0.3, sides=-1)
    my_car.set_pose_offset([-0.15, 0, 0], 1)     ###([-0.1, 0, 0], 1) 
...
def old_people():
    my_car.set_pose_offset([-0.2, 0, 0], 2)
    my_car.lane_dis_offset(0.3, 2)
    my_car.lane_sensor(0.2, value_h=0.3, sides=1)
    my_car.task.arm.switch_side(1)
    my_car.set_pose_offset([0.25, 0, 0])
    #my_car.task.arm.switch_side(1)
    my_car.task.arm.set(0.25, 0.05) 
